...
function VehicleTableRow({
  ...
  const getStatusBadge = () => {
    ...
    return (
      <span
        className={`px-2 py-1 rounded-full text-xs font-medium border ${statusColors[randomStatus]}`}
      >
        {randomStatus}
      </span>
    );
  ...
  return (
    <div className="flex flex-col items-center justify-center py-16 px-4">
      ...
      <p className="text-muted-foreground text-center mb-6 max-w-md">
        ...
        vehículo al sistema. Podrás
        gestionar toda la información y
        fotos desde aquí.
      </p>
      <Button
